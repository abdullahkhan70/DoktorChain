...
public class search_laboratory_getter_and_setter {
    ...
    public search_laboratory_getter_and_setter(int doctor_profile_image, String doctor_profile_name, String doctor_profile_destination, int facebook_profile, int twitter_profile, int linkedin_profile) {
