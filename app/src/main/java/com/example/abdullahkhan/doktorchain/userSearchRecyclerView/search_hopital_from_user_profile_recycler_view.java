...
public class search_hopital_from_user_profile_recycler_view extends RecyclerView.Adapter<search_hopital_from_user_profile_recycler_view.myViewHolder>
    ...
    private Context c;
    private List<search_hospital_getter_and_setter> list_of_doctor_profiles;
    private List<search_hospital_getter_and_setter> searchItems;


    public search_hopital_from_user_profile_recycler_view(List<search_hospital_getter_and_setter> list_of_doctor_profiles,Context c){
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        search_hospital_getter_and_setter doctor_profiles = list_of_doctor_profiles.get(position);
    ...
    public void filteredListing(ArrayList<search_hospital_getter_and_setter> filteredList) {
    ...
    public class myViewHolder extends RecyclerView.ViewHolder{
        ...
        public myViewHolder(View itemView) {
            super(itemView);
            user_profile_doctor = itemView.findViewById(R.id.user_hospital_name);
            doctor_name = itemView.findViewById(R.id.hospital_name);
            doctor_occupation = itemView.findViewById(R.id.hospital_specialist);
            facebook_user_doctor_social_media = itemView.findViewById(R.id.facebook_user_hospital_social_media);
            twitter_user_doctor_social_media = itemView.findViewById(R.id.twitter_user_hospital_social_media);
            linkedin_user_doctor_social_media = itemView.findViewById(R.id.linkedin_user_hospital_social_media);
            user_profile_view_profile = itemView.findViewById(R.id.hospital_profile_view_profile);
