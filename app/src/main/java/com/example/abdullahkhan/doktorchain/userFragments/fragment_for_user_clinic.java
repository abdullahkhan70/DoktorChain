...
public class fragment_for_user_clinic extends Fragment  {
    ...
    Toolbar toolbar;
    EditText searchView_clinic_name;
    ...
    public void onViewCreated(@androidx.annotation.NonNull View view, Bundle savedInstanceState) {
        ...
        searchView_clinic_name = view.findViewById(R.id.search_clinics_name);

        searchView_clinic_name.addTextChangedListener(new TextWatcher() {
            @Override
        ...
        SearchableSpinner searchabelSpecialization = view.findViewById(R.id.user_clinics_specialization);
        ...
        SearchableSpinner searchabelRangeFee = view.findViewById(R.id.user_clinics_range_fee);
        ...
        mAdapter = new search_clinic_from_user_profile_recycler_view(list_of_doctor_profile,c);

        recyclerView = view.findViewById(R.id.clinics_recycler_view);
